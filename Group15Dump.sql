...
INSERT INTO `applications` VALUES (2,3,730001435,'testing1','testing2','porpoise');
...
INSERT INTO `certifications` VALUES (1,'test','test','test');
...
INSERT INTO `classes` VALUES (2,'csce310','tmp','tmp');
...
CREATE TABLE `College_Student` (
  ...
  `Hispanic_Latino` tinyint(1) DEFAULT NULL,
  `Race` varchar(255) DEFAULT NULL,
  `US_Citizen` tinyint(1) DEFAULT NULL,
  `First_Generation` tinyint(1) DEFAULT NULL,
  `DoB` date DEFAULT NULL,
  `GPA` float DEFAULT NULL,
  `Major` varchar(255) DEFAULT NULL,
  `Minor_1` varchar(255) DEFAULT NULL,
  `Minor_2` varchar(255) DEFAULT NULL,
  `Expected_Graduation` year DEFAULT NULL,
  `School` varchar(255) DEFAULT NULL,
  `Current_Classification` varchar(255) DEFAULT NULL,
  `Phone` bigint DEFAULT NULL,
  `Student_Type` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`UIN`),
  CONSTRAINT `college_student_ibfk_1` FOREIGN KEY (`UIN`) REFERENCES `Users` (`UIN`) ON DELETE CASCADE
...
INSERT INTO `College_Student` VALUES (123456789,'',0,'',0,0,'2001-12-20',3.8,'comp sci',NULL,NULL,NULL,NULL,NULL,NULL,NULL),(152935183,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(730001435,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(930005110,'Other',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'undergrad2');
...
INSERT INTO `documentation` VALUES (5,2,'Link','Resume'),(8,2,'resumelink','resume'),(9,2,'transcriptlink','transcript');
/*!40000 ALTER TABLE `documentation` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `event_attendance_v`
--

DROP TABLE IF EXISTS `event_attendance_v`;
/*!50001 DROP VIEW IF EXISTS `event_attendance_v`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `event_attendance_v` AS SELECT 
 1 AS `Event_ID`,
 1 AS `Program_Num`,
 1 AS `Event_Type`,
 1 AS `UIN`,
...
INSERT INTO `internships` VALUES (2,'test','test',_binary '');
...
INSERT INTO `programs` VALUES (1,'Sample Program','This is a sample program description.'),(3,'fortnite','shooting and building');
...
--
-- Temporary view structure for view `student_doc_v`
--

DROP TABLE IF EXISTS `student_doc_v`;
/*!50001 DROP VIEW IF EXISTS `student_doc_v`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `student_doc_v` AS SELECT 
 1 AS `Doc_Num`,
 1 AS `App_Num`,
 1 AS `Doc_Type`,
 1 AS `Link`,
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2023-11-27 00:14:56',NULL),('diagnostics.include_raw','OFF','2023-11-27 00:14:56',NULL),('ps_thread_trx_info.max_length','65535','2023-11-27 00:14:56',NULL),('statement_performance_analyzer.limit','100','2023-11-27 00:14:56',NULL),('statement_performance_analyzer.view',NULL,'2023-11-27 00:14:56',NULL),('statement_truncate_len','64','2023-11-27 00:14:56',NULL);
...
INSERT INTO `Users` VALUES (123445678,'bob',NULL,'dylan','bob','pw','admin','bob@gmail.com','bobby#1241'),(123456789,'kyle','','d','','','','',''),(152935183,'kyle',NULL,'diano2','testo','pw','college_student','t@gmail.com',NULL),(730001435,'emil',NULL,'agbigay','em','pw','college_student','emil@gmail.com',NULL),(930005110,'bob',NULL,'marley','bobby','pw','college_student','bob.marely@gmail.com',NULL),(930005170,'JohnD',NULL,'Doe2','john','pw','admin','johndoe@example.com','JohnD#1234'),(930005180,'johnny',NULL,'appleseed','jon','pw','admin','jon@gmail.com','jon#2141');
/*!40000 ALTER TABLE `Users` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `usertyperolesview`
--

DROP TABLE IF EXISTS `usertyperolesview`;
/*!50001 DROP VIEW IF EXISTS `usertyperolesview`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `usertyperolesview` AS SELECT 
 1 AS `UIN`,
 1 AS `User_Type`,
 1 AS `Student_Type`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `event_attendance_v`
--
...
/*!50001 VIEW `event_attendance_v` AS select `E`.`Event_ID` AS `Event_ID`,`E`.`Program_Num` AS `Program_Num`,`E`.`Event_Type` AS `Event_Type`,`U`.`UIN` AS `UIN`,`U`.`First_Name` AS `First_Name`,`U`.`Last_Name` AS `Last_Name` from ((`events` `E` join `event_tracking` `ET` on((`E`.`Event_ID` = `ET`.`Event_ID`))) join `users` `U` on((`U`.`UIN` = `ET`.`UIN`))) */;
...
--
-- Final view structure for view `student_doc_v`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `student_doc_v` AS select `D`.`Doc_Num` AS `Doc_Num`,`D`.`App_Num` AS `App_Num`,`D`.`Doc_Type` AS `Doc_Type`,`D`.`Link` AS `Link`,`A`.`UIN` AS `UIN` from ((`college_student` `CS` join `applications` `A` on((`CS`.`UIN` = `A`.`UIN`))) join `documentation` `D` on((`A`.`App_Num` = `D`.`App_Num`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `usertyperolesview`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `usertyperolesview` AS select `u`.`UIN` AS `UIN`,`u`.`User_Type` AS `User_Type`,`s`.`Student_Type` AS `Student_Type` from (`users` `u` left join `college_student` `s` on((`u`.`UIN` = `s`.`UIN`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-12-08 22:52:29
